...
namespace SprintRetrospectiveApp.Models
{
    public class Project
    {
        ...
        public Project(int Id, string ProjectName, string TeamName, string TeamNumber, string HyperlinkClickup, DateTime StartDate, double InitialVelocity, double HoursPerStoryPoint, List<UserStory> UserStoryCollection, List<Sprint> SprintCollection)
