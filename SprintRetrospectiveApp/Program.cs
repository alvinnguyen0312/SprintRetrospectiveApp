...
namespace SprintRetrospectiveApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var listStories = proj.GetAllUserStoryByUserID(2, 0);
            ...
            //double totalTime = proj.GetTotalEstimatedTimeByUserIdAndStoryId(2,2,0);
            //Console.WriteLine(totalTime);

            //Get user story by Sprint ID
            //var userStoryBySprint = proj.GetAllUserStoryBySprintID(1, 0);
            ...
            //var userstories = proj.GetAllUserStoryByStatus("Planned", 0);
            ...
            //var subTasklist = proj.GetAllSubtasksByUserStory(2, 0);
